...
**Pure diagnostic infrastructure for the LTX toolchain.** This crate defines
**no domain errors** — it only provides the building blocks other crates plug
into to report, render, and serialize diagnostics.
